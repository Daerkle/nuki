...
if default_prompt_suggestions == []:
    default_prompt_suggestions = [
        {
            "title": ["Hilf mir beim Lernen", "für eine wichtige Prüfung"],
            "content": "Hilf mir beim Vokabellernen: Schreibe einen Satz mit einer Lücke, die ich ausfüllen muss, und gib mir mehrere Optionen zur Auswahl.",
        },
        {
            "title": ["Gib mir Ideen", "für ein nachhaltiges Wochenende"],
            "content": "Was sind 5 kreative Ideen für ein nachhaltiges und umweltfreundliches Wochenende mit der Familie?",
        },
        {
            "title": ["Erzähle mir etwas Interessantes", "über die deutsche Geschichte"],
            "content": "Erzähle mir eine interessante und wenig bekannte Tatsache über die deutsche Geschichte.",
        },
        {
            "title": ["Zeige mir Code", "für eine responsive Navigation"],
            "content": "Zeige mir ein Code-Beispiel für eine responsive Navigation mit HTML, CSS und JavaScript, die auf mobilen Geräten gut funktioniert.",
        },
        {
            "title": [
                "Erkläre mir Kryptowährungen",
                "in einfachen Worten",
            ],
            "content": "Erkläre mir in einfachen Worten, was Kryptowährungen sind und wie sie funktionieren, als würdest du es einem Anfänger erklären.",
        },
        {
            "title": ["Hilf mir produktiver zu werden", "mit praktischen Tipps"],
            "content": "Kannst du mich zuerst nach meinen größten Zeitfressern fragen und mir dann konkrete Tipps geben, wie ich produktiver werden kann?",
        },
    ]
