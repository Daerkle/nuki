					...
					<div class=" space-y-3">
						...
						<div class="grid lg:grid-cols-2 flex-col gap-1.5">
							{#each promptSuggestions as prompt, promptIdx}
								<div
									class=" flex border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-xl py-1.5"
								>
									<div class="flex flex-col flex-1 pl-1">
										<div class="flex border-b border-gray-200 dark:border-gray-700 w-full">
											<input
												class="px-3 py-1.5 text-xs w-full bg-transparent outline-hidden border-r border-gray-200 dark:border-gray-700"
										...
										<textarea
											class="px-3 py-1.5 text-xs w-full bg-transparent outline-hidden border-r border-gray-200 dark:border-gray-700 resize-none"
											placeholder={$i18n.t(
						...
						<div class="flex items-center justify-end space-x-2 mt-2">
							...
							<button
								class="flex text-xs items-center space-x-1 px-3 py-1.5 rounded-xl bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 transition"
								type="button"
								on:click={() => {
