							...
							<div class={($settings?.chatBubble ?? true) ? 'self-end' : ''}>
								...
								{:else}
									<FileItem
										...
										type={file.type}
										size={file?.size}
										colorClassName="bg-white dark:bg-gray-800 "
									/>
								{/if}
							</div>
						{/each}
						...
						<div class=" mt-2 mb-1 flex justify-between text-sm font-medium">
							<div>
								<button
									...
									class=" px-4 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 transition rounded-3xl"
									on:click={() => {
							...
							<div class="flex space-x-1.5">
								...
								<button
									...
									class=" px-4 py-2 bg-gray-900 dark:bg-white hover:bg-gray-800 text-gray-100 dark:text-gray-800 transition rounded-3xl"
									on:click={() => {
						...
						<div class="flex {($settings?.chatBubble ?? true) ? 'justify-end pb-1' : 'w-full'}">
							<div
								class="rounded-3xl {($settings?.chatBubble ?? true)
									? `max-w-[90%] px-5 py-2  bg-gray-100 dark:bg-gray-800 ${
