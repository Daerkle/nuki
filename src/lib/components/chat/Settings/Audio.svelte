			...
			{#if $config.audio.stt.engine !== 'web'}
				<div class=" py-0.5 flex w-full justify-between">
					...
					<div class="flex items-center relative">
						<select
							class="bg-gray-50 dark:bg-gray-900 w-fit pr-8 rounded-sm px-2 p-1 text-xs bg-transparent outline-hidden text-right"
					...
					<div class="flex items-center relative text-xs px-3">
						...
						>
							<input
								...
								class=" text-sm text-right bg-transparent text-gray-700 dark:text-gray-300 outline-hidden"
							/>
						</Tooltip>
					</div>
				</div>
				...
				<div>
					...
					<div class="flex w-full">
						<div class="flex-1">
							<input
								list="voice-list"
								class="w-full text-sm bg-transparent text-gray-700 dark:text-gray-300 outline-hidden"
								bind:value={voice}
